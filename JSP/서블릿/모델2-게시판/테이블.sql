create table board(
num NUMBER not null primary key , --게시판 글 번호
...
ref NUMBER not null,-- 글 그룹 번호, 관련 글 묶음, 답글
re_step NUMBER not null, -- 같은 그룹에서 글 출력 순서
re_level NUMBER not null, -- 답글 레벨 - 들여쓰는 레벨 
content varchar2(4000) not null, -- 글 내용
ip varchar(20) not null -- 작성자 아이피
);

create SEQUENCE board_seq; --자동으로 일련번호를 생성해줌
